				...
				<script>
					$(function(){
						$("#registbutton").click(function(){
							...
							let rno = 0;
							let writenBtn = 0;
							let rContent = $("[name=rContent]").val();
							let comment = $("#comment").val();
							$ajax({
								type: 'post',
								url: "SocialCommentServlet",
								data: {"id": id, "bno": bno, "rno": rno, "writenBtn": writenBtn, "rContent": rContent, "comment": comment},
								datatype: "json",
...
<!-- 						<input type="hidden" name="writeBtn" value="0"/> -->
						...
						<button type="button" class="registbtn" id="registbutton" name="comment" value="mainComment">등록</button>
				</div>
				<ul class="commentall">
					<%
...
<!-- 											<input type="hidden" name="writeBtn" value=""/> -->
											<button type="button" class="del" name="comment" value="deleteComment">삭제</button>
<!-- 										</form> -->
