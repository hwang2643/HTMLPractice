...
<%
	...
	//		oQty = request.getParameter("amount");
	} catch(Exception e) {
		id = "";
	//		goodsSize = "";
	//		goodsId = "";
								...
								<td>
									...
									<div class="pay_btn_wrap">
										<div class="pay_btn_box">
											<button type="submit" onclick="location.href='EShopMain.jsp'"><img src="https://www.fcseoul.com/resources/shop/_img/btn/btn_okey.gif"/></button>
 										</div>
									</div>
								</td>
							</tr>
