...
<%
	...
	String sql2 = " SELECT r1.* FROM (SELECT rownum rnum, g.* FROM goods g WHERE new='https://www.fcseoul.com/resources/shop/_img/icon/icon_new.gif' AND best='https://www.fcseoul.com/resources/shop/_img/icon/icon_best.gif' ORDER BY goods_id) r1 WHERE r1.rnum<=4";
					...
					%>
						...
						<div class="page_box">
							<div class="page_btn">
								...
								&nbsp;&nbsp;
								<a href="EShopNewPage.jsp?page=1" class="pg">
									<b style="color:#d2232a">1</b>
								</a>
								<a href="EShopNewPage.jsp?page=2" class="pg">
									<b style="color:#d2232a">2</b>
								</a>
								<a href="EShopNewPage.jsp?page=3" class="pg">
									<b style="color:#d2232a">3</b>
								</a>
								<a href="EShopNewPage.jsp?page=4" class="pg">
