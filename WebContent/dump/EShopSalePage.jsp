...
<%
	...
	String sql2 = " SELECT r1.* FROM (SELECT rownum rnum, g.* FROM goods g WHERE sale='https://www.fcseoul.com/resources/shop/_img/icon/icon_sale.gif' AND best='https://www.fcseoul.com/resources/shop/_img/icon/icon_best.gif' ORDER BY goods_id) r1 WHERE r1.rnum<=4";
					...
					%>
						...
						<div class="page_box">
							<div class="page_btn">
								...
								&nbsp;&nbsp;
								<a href="EShopSalePage.jsp?page=1" class="pg">
