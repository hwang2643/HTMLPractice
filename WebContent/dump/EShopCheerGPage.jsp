...
<%
	...
	String sql = " SELECT g2.*"
				...
				+" FROM(SELECT * FROM goods WHERE type='응원용품' ORDER BY goods_id) g1) g2"
				+" WHERE g2.rnum>=? AND g2.rnum<=?";
	String sql2 = " SELECT * FROM (SELECT * FROM goods WHERE type='응원용품' AND best='https://www.fcseoul.com/resources/shop/_img/icon/icon_best.gif' ORDER BY goods_id) WHERE rownum<=4";
					...
					%>
						...
						<div class="page_box">
							<div class="page_btn">
								...
								&nbsp;&nbsp;
								<a href="EShopCheerGPage.jsp?page=1" class="pg">
