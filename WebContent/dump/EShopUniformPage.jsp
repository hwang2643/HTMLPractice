...
<%
	...
	String sql = " SELECT g2.*"
				...
				+" FROM(SELECT * FROM goods WHERE type='유니폼' ORDER BY goods_id) g1) g2"
					...
					%>
						...
						<div class="page_box">
							<div class="page_btn">
								...
								&nbsp;&nbsp;
								<a href="EShopUniformPage.jsp?page=1" class="pg">
									<b style="color:#d2232a">1</b>
								</a>
								<a href="EShopUniformPage.jsp?page=2" class="pg">
									2
								</a>
								<a href="EShopUniformPage.jsp?page=3" class="pg">
									3
								</a>
								&nbsp;&nbsp;
								<a href="">
