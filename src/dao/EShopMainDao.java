...
public class EShopMainDao {
	...
	public ArrayList<EShopMainDto> EShopMainPrd(String cate) throws Exception {
	...
	public ArrayList<EShopMainDto> EShopMainBestPrd(String type) throws Exception {
	...
	public ArrayList<EShopMainDto> EShopMainSearch(String searchText) throws Exception {
